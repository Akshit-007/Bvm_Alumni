  ...
  return (
   <div>
    ...
    <Link to='/'  style={{textDecoration: 'none' , color:'black'}}><div className="name">BVM,<br/> ALUMNI ASSOCIATION</div></Link>
        ...
        <div className="search"><input type="text" placeholder="search"></input> <button className="srch"><i className="fa fa-search"></i></button> &nbsp;<i className="fa fa-server"  onClick={()=>{show()}}></i></div>
    </div>
    <div className="nav">
        <ul>
